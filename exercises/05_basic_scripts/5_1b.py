...
routers = ', '.join(list(london_co))

device_name = input('Введите имя устройства из предложенных ({}): '.format(routers))

parametrs = ', '.join(list(london_co[device_name]))

parametr_name = input('Введите имя параметра ({}): '.format(parametrs))
